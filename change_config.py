...
def edit(
    train_dir, eval_dir, batch_size, checkpoint, label_map, brightness, learning_rate
):
    """
    ...
    pipeline_config = text_format.Merge(
        "train_config { optimizer { momentum_optimizer { learning_rate { cosine_decay_learning_rate { learning_rate_base: "
        + str(learning_rate)
        + " total_steps: 25000 warmup_learning_rate: 0.013333000242710114 warmup_steps: 2000}}}}}",
        pipeline_config,
    )
